...
def test_volcengine_douban_api(api_key: str):
    ...
    try:
        ...
        # 创建解析器实例
        parser = VolcengineDoubanParser(api_key)
...
"""
        ...
        print("🚀 最终修复的火山引擎豆包API测试")
        print("=" * 50)
        print(f"使用模型: doubao-seed-1-6-250615")
        print(f"API端点: https://ark.cn-beijing.volces.com/api/v3/chat/completions")
        ...
        print(f"❌ 导入失败: {e}")
        print("请确保 volcengine_douban_final.py 文件存在")
